...
const seven = 7;
const fiftyTwo = 52;
const outcomeTwo = seven * fiftyTwo;
...
const three = 3;
const outcomeThree = (four + three) * seven;
...
const six = 6;
const thirtySix = 36;
const outcomeFour = thirtySix / six * two;
...
const sweet = "zoet";
const juicy = "sappig";
const outcomeFive = sweet + juicy
console.log(outcomeFive);
